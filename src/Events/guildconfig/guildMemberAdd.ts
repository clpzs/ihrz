...
import { ActionRowBuilder, BaseGuildTextChannel, ButtonBuilder, ButtonStyle, Client, GuildFeature, GuildMember, Invite, PermissionsBitField } from "discord.js";
...
export default async (client: Client, member: GuildMember) => {
    ...
    blockBot(), joinRoles(), joinDm(), welcomeMessage();
};